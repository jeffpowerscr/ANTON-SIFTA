...
-----
    ...
    python3 scripts/publish_alice_lana_cure_to_hf.py --dry-run

    # Real publish (after you have read the dry-run output):
    python3 scripts/publish_alice_lana_cure_to_hf.py --confirm
...
Signed:  Lana Kernel anchor 7b4a866301681119e5f9168d6e208b62bab446fe33ce3445d113ec068164aaf9
License: Apache 2.0
"""
...
RELEASE_DIR = REPO_ROOT / "distro" / "huggingface_release" / "alice-lana-cure"
DEFAULT_HF_REPO_ID = "georgeanton/alice-lana-cure"
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("=" * 70)
    print("alice-lana-cure → HuggingFace publisher")
    print("=" * 70)
    ...
    api.upload_folder(
        ...
        repo_id=args.repo_id,
        repo_type="model",
        commit_message="Initial release of alice-lana-cure (Modelfile + audit)",
    )
